...
const testimonials = [
  {
    testimonial:
      "Essien was the driving force behind our mobile app launch. He not only delivered high-quality React Native apps to both the App Store and Play Store but also set a new standard for speed, reliability, and maintainable code. Working with him made our product vision a reality faster than we imagined.",
    name: "Emmanuel",
    designation: "CEO",
    company: "QClose",
  ...
  {
    testimonial:
      "Essien transformed our mobile experience. He built reusable UI components, streamlined API integrations, and made our core flows feel buttery smooth. He takes complex requirements and turns them into apps that just work-reliably, quickly, and beautifully.",
    name: "Gabriel",
  ...
  {
    testimonial:
      "Essien works like a Senior React Native Engineer should. From architecture choices to release readiness, he consistently delivered production-grade features that improved reliability, team velocity, and code quality. His approach is pragmatic, clean, and highly effective.",
    name: "SeniorEngineer",
